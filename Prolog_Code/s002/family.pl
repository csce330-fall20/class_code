...
gender_but_not_person(Name) :- (male(Name);female(Name)),\+person(Name).

gender_but_not_person1(Name) :- female(Name),\+person(Name).
gender_but_not_person1(Name) :- male(Name),  \+person(Name).